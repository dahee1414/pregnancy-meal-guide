    ...
    if menu_input:
        ...
        return (
            ...
            keyword_nutrition = [
                ...
                {
                    "keywords": ["소고기", "쇠고기", "소불고기", "쇠불고기", "한우", "장조림"],
                    "name": "소고기류",
        ...
        def get_menu_advice(menu):
            ...
            spicy_keywords = ["쭈꾸미", "주꾸미", "낙지볶음", "제육볶음", "쭈꾸미삼겹살", "주꾸미삼겹살", "사천식", "사천", "해물잡채", "사천식해물잡채", "골뱅이무침", "골뱅이야채무침", "아삭이고추무침", "고추무침", "마라", "볶음"]
            ...
            # 채소/과일
            vegetable_keywords = ["샐러드", "오이", "당근", "양배추", "상추", "깻잎", "야채쌈", "채소쌈", "쌈채소", "나물", "버섯", "새송이", "고추", "아삭이고추", "과일", "사과", "오렌지", "딸기", "귤", "감", "홍시", "시트러스"]
