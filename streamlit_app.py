    ...
    if menu_input:
        ...
        def find_nutrition(menu):
            ...
            keyword_nutrition = [
                ...
                {
                    "keywords": ["쭈꾸미", "주꾸미", "낙지", "오징어", "문어", "해산물"],
                    "name": "해산물류",
        ...
        def get_menu_advice(menu):
            ...
            salty_keywords = ["피클", "장아찌", "젓갈", "김치", "깍두기", "쌈장", "된장", "고추장"]
            fried_keywords = ["튀김", "감자튀김", "회오리감자", "돈까스", "치킨너겟"]
            spicy_keywords = ["쭈꾸미", "주꾸미", "낙지볶음", "제육볶음", "쭈꾸미삼겹살", "주꾸미삼겹살", "볶음"]
            ...
            # 적극 권장 메뉴
            high_keywords = ["닭", "소고기", "쇠고기", "돼지고기", "생선", "계란", "두부", "콩", "우유", "요구르트", "요거트", "치즈", "시금치", "브로콜리", "쭈꾸미", "주꾸미", "삼겹살"]
            ...
            # 채소/과일
            vegetable_keywords = ["샐러드", "오이", "당근", "양배추", "상추", "깻잎", "야채쌈", "채소쌈", "쌈채소", "나물", "과일", "사과", "오렌지", "딸기", "귤", "시트러스"]
