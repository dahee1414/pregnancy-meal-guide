...
with tab1:
    ...
    if menu_input:
        ...
        # 영양소 데이터베이스 (음식명: [칼로리, 단백질(g), 철분(mg), 칼슘(mg), DHA(mg)])
        nutrition_db = {
            "밥": [195, 4.3, 0.3, 10, 0],
...
---
                ...
                st.warning(f"❓ '{menu}'에 대한 데이터가 없습니다. 인덱스를 확인해주세요.")
...
with tab4:
    ...
    3. "🍽️ 급식 분석" 탭에서 오늘의 급식 메뉴를 쉼표로 구분하여 입력합니다.
    ...
    #### 💬 피드백
    앱 개선을 위한 의견이나 건의사항이 있으시면 언제든 연락 부탁드립니다.
    """)
